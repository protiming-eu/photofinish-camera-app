...
public class MainUI {
    ...
    private void layoutUI(boolean popup_container_only) {
        ...
        if( !popup_container_only )
        {
            ...
            view = main_activity.findViewById(R.id.standby_mode);
            layoutParams = (RelativeLayout.LayoutParams)view.getLayoutParams();
            if( ui_placement == UIPlacement.UIPLACEMENT_LEFT ) {
                layoutParams.addRule(align_parent_left, RelativeLayout.TRUE);
                layoutParams.addRule(align_parent_right, 0);
                setMarginsForSystemUI(layoutParams, navigation_gap, 0, 0, 0);
            }
            else {
                layoutParams.addRule(align_parent_left, 0);
                layoutParams.addRule(align_parent_right, RelativeLayout.TRUE);
            ...
            layoutParams.addRule(align_parent_bottom, 0);
            layoutParams.addRule(ui_independent_above, 0);
            layoutParams.addRule(ui_independent_below, R.id.switch_video);
            layoutParams.addRule(ui_independent_left_of, 0);
            layoutParams.addRule(ui_independent_right_of, 0);
            view.setLayoutParams(layoutParams);
            setViewRotation(view, ui_rotation);
            ...
            layoutParams.addRule(right_of, 0);
            view.setLayoutParams(layoutParams);
            int margin = (int) (80 * scale + 0.5f); // move zoom slider more to the left in landscape

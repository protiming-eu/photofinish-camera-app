...
public class CameraController2 extends CameraController {
    ...
    private class CameraSettings {
        ...
        private boolean setAEMode(CaptureRequest.Builder builder, boolean is_still) {
            ...
            if( has_iso && (!is_video_high_speed || supports_manual_control_for_high_speed) ) {
                ...
                // Set FPS range for manual ISO mode - required for high speed video!
                if( ae_target_fps_range != null ) {
                    if( MyDebug.LOG )
                        Log.d(TAG, "set ae_target_fps_range for manual ISO: " + ae_target_fps_range);
    ...
    public boolean supportsManualISOForHighSpeed() {
